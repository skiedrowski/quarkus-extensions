...
/**
 * {@link io.quarkus.rest.data.panache.kotlin.RestDataResource} implementor that generates data access logic depending on which
...
class ResourceImplementor {
    ...
    /**
     * Implements {@link io.quarkus.rest.data.panache.kotlin.RestDataResource} interfaces defined in a user application.
