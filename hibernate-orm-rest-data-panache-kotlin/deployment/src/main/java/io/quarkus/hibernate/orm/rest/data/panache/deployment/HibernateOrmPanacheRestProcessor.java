...
import static io.quarkus.rest.data.panache.kotlin.deployment.utils.EntityTypeUtils.getEntityFields;
import static io.quarkus.rest.data.panache.kotlin.deployment.utils.EntityTypeUtils.getListenersByEntityType;
...
import io.quarkus.hibernate.orm.rest.data.panache.kotlin.runtime.RestDataPanacheExceptionMapper;
import io.quarkus.hibernate.orm.rest.data.panache.kotlin.runtime.jta.TransactionalUpdateExecutor;
import io.quarkus.rest.data.panache.kotlin.RestDataPanacheException;
import io.quarkus.rest.data.panache.kotlin.deployment.ResourceMetadata;
import io.quarkus.rest.data.panache.kotlin.deployment.ResourceMethodListenerBuildItem;
import io.quarkus.rest.data.panache.kotlin.deployment.RestDataResourceBuildItem;
...
class HibernateOrmPanacheRestProcessor {
    ...
    public static final String FEATURE = "hibernate-orm-rest-data-panache-kotlin";//TODO add to FEATURES Enum?
