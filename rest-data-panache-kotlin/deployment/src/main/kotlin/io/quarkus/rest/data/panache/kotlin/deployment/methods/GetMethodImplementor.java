...
import io.quarkus.rest.data.panache.kotlin.deployment.methods.StandardMethodImplementor;
...
public final class GetMethodImplementor extends StandardMethodImplementor {
     ...
     * </pre>
     *
     * The RESTEasy Reactive version exposes {@link io.quarkus.rest.data.panache.kotlin.ReactiveRestDataResource#delete(Object)}
     * and the generated code looks more or less like this:
     *
     * <pre>
     * {@code
