package io.quarkus.rest.data.panache.kotlin.deployment.properties;
...
import io.quarkus.rest.data.panache.kotlin.deployment.utils.ResourceName;
import jakarta.annotation.security.RolesAllowed;

public class ResourcePropertiesProvider {

    private static final DotName RESOURCE_PROPERTIES_ANNOTATION = DotName
            .createSimple(io.quarkus.rest.data.panache.kotlin.ResourceProperties.class.getName());

    private static final DotName METHOD_PROPERTIES_ANNOTATION = DotName.createSimple(
            io.quarkus.rest.data.panache.kotlin.MethodProperties.class.getName());
